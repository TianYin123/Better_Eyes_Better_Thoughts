...
@LLMRegistry.register("OpenAI-Compatible")
class OpenAICompatible:
    def __new__(cls, model_path: str, args: Any) -> Any:
        from models.OpenAI_Compat_VLM.OpenAI_Compat_VLM import OpenAICompatVLM
        return OpenAICompatVLM(model_path, args)
...
class Hulumed_qwen2:
    def __new__(cls, model_path: str, args: Any) -> Any:
        from models.CustomModel_A.CustomModel_A import CustomModel_A
        return CustomModel_A(model_path, args)
@LLMRegistry.register("Hulumed_qwen3")
class Hulumed_qwen3:
    def __new__(cls, model_path: str, args: Any) -> Any:
        from models.CustomModel_B.CustomModel_B import CustomModel_B
        return CustomModel_B(model_path, args)
